    ...
    public static function arrty_to_tree($sourceArr, $key, $parentKey, $childrenKey)
    {
        ...
        for($i = ($count - 1); $i >= 0; $i --) {
            if (isset($tempSrcArr[$sourceArr[$i][$parentKey]])) {
                ...
                $tempSrcArr[$tArr[$parentKey]][$childrenKey] = (isset($tempSrcArr[$tArr[$parentKey]][$childrenKey]) && 
                is_array($tempSrcArr[$tArr[$parentKey]][$childrenKey])) ? $tempSrcArr[$tArr[$parentKey]][$childrenKey] : [];

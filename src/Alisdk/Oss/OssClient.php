<?php
namespace finger\Alisdk\Oss;

use finger\Alisdk\Oss\Core\MimeTypes;
use finger\Alisdk\Oss\Core\OssException;
use finger\Alisdk\Oss\Http\RequestCore;
use finger\Alisdk\Oss\Http\RequestCoreException;
use finger\Alisdk\Oss\Http\ResponseCore;
use finger\Alisdk\Oss\Model\CorsConfig;
use finger\Alisdk\Oss\Model\CnameConfig;
use finger\Alisdk\Oss\Model\LoggingConfig;
use finger\Alisdk\Oss\Model\LiveChannelConfig;
use finger\Alisdk\Oss\Model\LiveChannelInfo;
use finger\Alisdk\Oss\Model\LiveChannelListInfo;
use finger\Alisdk\Oss\Result\AclResult;
use finger\Alisdk\Oss\Result\BodyResult;
use finger\Alisdk\Oss\Result\GetCorsResult;
use finger\Alisdk\Oss\Result\GetLifecycleResult;
use finger\Alisdk\Oss\Result\GetLoggingResult;
use finger\Alisdk\Oss\Result\GetRefererResult;
use finger\Alisdk\Oss\Result\GetWebsiteResult;
use finger\Alisdk\Oss\Result\GetCnameResult;
use finger\Alisdk\Oss\Result\HeaderResult;
use finger\Alisdk\Oss\Result\InitiateMultipartUploadResult;
use finger\Alisdk\Oss\Result\ListBucketsResult;
use finger\Alisdk\Oss\Result\ListMultipartUploadResult;
use finger\Alisdk\Oss\Model\ListMultipartUploadInfo;
use finger\Alisdk\Oss\Result\ListObjectsResult;
use finger\Alisdk\Oss\Result\ListPartsResult;
use finger\Alisdk\Oss\Result\PutSetDeleteResult;
use finger\Alisdk\Oss\Result\DeleteObjectsResult;
use finger\Alisdk\Oss\Result\CopyObjectResult;
use finger\Alisdk\Oss\Result\CallbackResult;
use finger\Alisdk\Oss\Result\ExistResult;
use finger\Alisdk\Oss\Result\PutLiveChannelResult;
use finger\Alisdk\Oss\Result\GetLiveChannelHistoryResult;
use finger\Alisdk\Oss\Result\GetLiveChannelInfoResult;
use finger\Alisdk\Oss\Result\GetLiveChannelStatusResult;
use finger\Alisdk\Oss\Result\ListLiveChannelResult;
use finger\Alisdk\Oss\Result\AppendResult;
use finger\Alisdk\Oss\Model\ObjectListInfo;
use finger\Alisdk\Oss\Result\UploadPartResult;
use finger\Alisdk\Oss\Model\BucketListInfo;
use finger\Alisdk\Oss\Model\LifecycleConfig;
use finger\Alisdk\Oss\Model\RefererConfig;
use finger\Alisdk\Oss\Model\WebsiteConfig;
use finger\Alisdk\Oss\Core\OssUtil;
use finger\Alisdk\Oss\Model\ListPartsInfo;
